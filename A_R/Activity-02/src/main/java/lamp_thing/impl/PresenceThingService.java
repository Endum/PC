 ...
 *
 */
public class PresenceThingService extends AbstractVerticle {

	private DetectionThingAPI model;
	private List<ThingAbstractAdapter> adapters;
	
	public static final int HTTP_PORT = 8890;
	
	public PresenceThingService(DetectionThingAPI model) {
		this.model = model;
	...
	protected void installAdapters(Promise<Void> promise) {		
		...
		try {
			 ...
			 */
			PresenceThingHTTPAdapter httpAdapter = new PresenceThingHTTPAdapter(model, "localhost", HTTP_PORT, this.getVertx());
	...
	protected void log(String msg) {
		System.out.println("[PresenceThingService] " + msg);
	}
}
