...
/**
 * 
 * Model of the Detector Digital Twin 
 * 
 * @author aricci
 *
 */
public class DetectorDTModel implements DetectorDTAPI, DetectorDTShadAPI {
	...
	public DetectorDTModel(String dtId) {
		this.dtId = dtId;		
	}
	...
	protected void log(String msg) {
		System.out.println("[DetectorDTModel]["+System.currentTimeMillis()+"] " + msg);
	}
