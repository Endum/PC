...
public class DetectorDTAdapter  {
	...
	public DetectorDTAdapter(DetectorDTAPI model, int port, Vertx vertx) {
		this.model = model;
		this.vertx = vertx;
		this.dtPort = port;
	}
	...
	protected void log(String msg) {
		System.out.println("[DetectorThingHTTPAdapter][" + System.currentTimeMillis() + "] " + msg);
	}
