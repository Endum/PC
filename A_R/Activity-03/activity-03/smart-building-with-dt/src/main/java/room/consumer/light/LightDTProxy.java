 ...
 *
 */
public class LightDTProxy implements LightDTAPI {
	...
	public LightDTProxy(String dtHost, int dtPort){
		this.dtPort = dtPort;
		this.dtHost = dtHost;
	}
	...
	protected void log(String msg) {
		System.out.println("[LightDTProxy]["+System.currentTimeMillis()+"] " + msg);
	}
