...
public class DetectorThingHTTPAdapter extends ThingAbstractAdapter<DetectorThingAPI> {
	...
	public DetectorThingHTTPAdapter(DetectorThingAPI model, String host, int port, Vertx vertx) {
		super(model, vertx);
		this.thingHost = host;
		this.thingPort = port;
	}
