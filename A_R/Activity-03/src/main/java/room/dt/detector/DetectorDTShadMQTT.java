...
/**
 * Detector sensor DT in-bound Shadowing module, based on MQTT protocol
 * 
 * @author aricci
 *
 */
public class DetectorDTShadMQTT  {
	...
	private DetectorDTShadAPI model;
	private String dtId;
	...
	public DetectorDTShadMQTT(DetectorDTShadAPI model, String dtId, String thingId, String host, int port) throws Exception {
		this.model = model;
	...
	protected void log(String msg) {
		System.out.println("[DetectorDTShadMQTT]["+System.currentTimeMillis()+"] " + msg);
	}
