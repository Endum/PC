...
/**
 * 
 * Model of the Light Digital Twin 
 * 
 * @author aricci
 *
 */
public class LightDTModel implements LightDTAPI, LightDTShadAPI {
	...
	public LightDTModel(String dtId) {
		this.dtId = dtId;		
	}
	...
	protected void log(String msg) {
		System.out.println("[LightDTModel]["+System.currentTimeMillis()+"] " + msg);
	}
