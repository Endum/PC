...
public class LampDTShadMQTT  {
	...
	private int reqId = 0;
	private final String consumerRepliesTopic = "responseTopic";
	private final String thingRequestsTopic = "actions";
	private final String thingEventsTopic = "stateChanged";
	private final Map<Integer, Promise> pendingReqs;
