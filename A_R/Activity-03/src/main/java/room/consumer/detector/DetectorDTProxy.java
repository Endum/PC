 ...
 *
 */
public class DetectorDTProxy implements DetectorDTAPI {
	...
	public DetectorDTProxy(String dtHost, int dtPort){
		this.dtPort = dtPort;
		this.dtHost = dtHost;
	}
	...
	protected void log(String msg) {
		System.out.println("[DetectorDTProxy]["+System.currentTimeMillis()+"] " + msg);
	}
