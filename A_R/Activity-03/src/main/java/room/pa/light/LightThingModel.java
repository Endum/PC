...
public class LightThingModel implements LightThingAPI {
	...
	private LightDeviceSimulator ls;
	

	public LightThingModel(String thingId) {
		log("Creating the light  simulator.");
		this.thingId = thingId;
		ls = new LightDeviceSimulator(thingId);
	}
	...
	protected void log(String msg) {
		System.out.println("[LightThingModel]["+System.currentTimeMillis()+"] " + msg);
	}
