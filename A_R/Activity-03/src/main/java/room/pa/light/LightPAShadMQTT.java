...
/**
 * Light sensor Physical Asset shadowing module, based on MQTT
 * 
 * @author aricci
 *
 */
public class LightPAShadMQTT {
	...
	public LightPAShadMQTT(LightThingAPI model, String LampThingDTId, String host, int port, Vertx vertx) throws Exception {
		this.host = host;
		this.port = port;
		this.model = model;
		this.vertx = vertx;
