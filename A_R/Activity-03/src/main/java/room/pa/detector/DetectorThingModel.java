 ...
 *
 */
public class DetectorThingModel implements DetectorThingAPI {
	...
	private DetectorDeviceSimulator pd;
	

	public DetectorThingModel(String thingId) {
		log("Creating the presence detection simulator.");
		this.thingId = thingId;
		pd = new DetectorDeviceSimulator(thingId);
	}
