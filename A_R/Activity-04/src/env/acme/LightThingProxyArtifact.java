...
public class LightThingProxyArtifact extends ThingProxyArtifact {
	...
	private static final String PROPERTY_STATE = "luminosity";
	private static final String EVENT_NAME = "luminosityChanged";
	...
	@OPERATION void getCurrentLuminosity(OpFeedbackParam<String> state) {
		try {
			log("getting the luminosity.");
