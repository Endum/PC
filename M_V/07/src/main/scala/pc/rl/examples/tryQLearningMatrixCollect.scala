...
object TryQMatrixCollect extends App:
  ...
  val rl: QMatrix.Facade = Facade(
    ...
    reward = { case ((0,0),_) => (collected.clear(), 0)._2;
               case ((a,b),_) if lab(b)(a) == "#" => if (collected.contains((a,b))) -10 else (collected.add((a,b)), 10)._2;
               case _ => -1},
  ...
  val q1 = rl.makeLearningInstance().learn(100_000,50,q0)
